...
export default function Header({}: props) {
    return (
      ...
      <div className="s flex flex-wrap items-center justify-between mx-auto p-4">
        
        {/* ส่วนโลโก้ (ตรงกับรูปที่ 1) */}
        <a href="#" className="flex items-center space-x-3 rtl:space-x-reverse">
          {/* อย่าลืมเอารูป logo.png ไปวางในโฟลเดอร์ public นะครับ */}
        ...
        {/* ปุ่มเมนูเวอร์ชั่นมือถือ (ส่วนนี้มักจะอยู่ขวาสุด) */}
        <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
            ...
            {/* ปุ่ม Hamburger สำหรับมือถือสามารถเพิ่มตรงนี้ได้ */}
        </div>

        {/* ส่วนลิ้งค์เมนู (ตรงกับรูปที่ 2) */}
